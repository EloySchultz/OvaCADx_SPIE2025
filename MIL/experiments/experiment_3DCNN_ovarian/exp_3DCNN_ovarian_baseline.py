experiment_folder = "/home/eloy/Documents/Graduation_project/Code/MIL/experiments/experiment_3DCNN_ovarian"
...
args = [
    ...
    "--k_end 25",
    "--lr 0.0000750",
    "--name '3CCNN_ovarian_baseline'",
    "--Desc '3CCNN_ovarian_baseline'"
]
